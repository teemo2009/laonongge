...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$data['tab_telephone_register'] = $this->language->get('tab_telephone_register');
		...
		if (isset($this->request->post['register_type'])) {
			$data['register_type'] = $this->request->post['register_type'];
		} else {
	...
	private function validate() {
		if (!isset($this->request->post['email']) &&  !isset($this->request->post['telephone'])) {
			$this->error['error_email_and_telephone_cannot_all_null'] = $this->language->get('error_email_and_telephone_cannot_all_null');
		}
