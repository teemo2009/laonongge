...
class ControllerCatalogDownload extends Controller {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['filename']) < 2) || (utf8_strlen($this->request->post['filename']) > 128)) {
		...
		if ((utf8_strlen($this->request->post['mask']) < 2) || (utf8_strlen($this->request->post['mask']) > 128)) {
