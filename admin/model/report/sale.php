...
class ModelReportSale extends Model {
	...
	public function getTotalOrdersByCountry() {
		$query = $this->db->query("SELECT COUNT(*) AS total, SUM(o.total) AS amount, c.iso_code_3 FROM `" . DB_PREFIX . "order` o LEFT JOIN `" . DB_PREFIX . "country` c ON (o.shipping_country_id = c.country_id) WHERE o.order_status_id > '0' GROUP BY o.payment_country_id");
