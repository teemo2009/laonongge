      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            ...
            <li class="disabled hidden"><a href="#tab-payment" data-toggle="tab">3. <?php echo $tab_payment; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('select[name=\'shipping_method\']').prop('disabled') ? $('a[href=\'#tab-cart\']').tab('show') : $('a[href=\'#tab-shipping\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
                <div class="col-sm-6 text-right">
...
$('#tab-shipping select[name=\'zone_id\']').on('change', function() {
    $.ajax({
        url: 'index.php?route=customer/customer/zone&token=<?php echo $token; ?>&zone_id=' + this.value,
        dataType: 'json',
        beforeSend: function() {
